...
target_include_directories(${TRIDIM_LIBRARY_NAME} PRIVATE ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_INCLUDE} )
...
if( TRIDIM_LIBRARY_EXT )
    ...
    target_include_directories(${TRIDIM_LIBRARY_NAME} PRIVATE ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_INCLUDE_EXT} )
endif()
...
ADD_LIBRARY_HEADER_DIRECTORY( ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_INCLUDE} )
ADD_LIBRARY_SOURCE_DIRECTORY( ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_SRC} )

if( TRIDIM_LIBRARY_EXT )
  ADD_LIBRARY_HEADER_DIRECTORY( ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_INCLUDE_EXT} )
  ADD_LIBRARY_SOURCE_DIRECTORY( ${CMAKE_SOURCE_DIR}/${TRIDIM_GRAPH_LIB_SRC_EXT} )
endif()
