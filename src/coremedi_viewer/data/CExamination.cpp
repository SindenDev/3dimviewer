...
CExamination::CExamination() : CStorageInterface(APP_STORAGE)
{
    ...
    VPL_SIGNAL(SigSetSliceARB).connect(this, &CExamination::setSlicePositionARB);
    ...
    VPL_SIGNAL(SigGetSliceARBDoublePos).connect(this, &CExamination::getSliceDoublePositionARB);
    ...
    VPL_SIGNAL(SigEnableMultiClassRegionColoring).connect(this, &CExamination::enableMultiClassRegionColoring);
    VPL_SIGNAL(SigIsMultiClassRegionColoringEnabled).connect(this, &CExamination::isMultiClassRegionColoringEnabled);
    VPL_SIGNAL(SigSetMultiClassRegionColor).connect(this, &CExamination::setMultiClassRegionColor);
    VPL_SIGNAL(SigGetMultiClassRegionColor).connect(this, &CExamination::getMultiClassRegionColor);
...

	{
        ...
        data::CSlicePropertyHandle<data::COrthoSliceXY, data::CMultiClassRegionData, data::CMultiClassRegionData::tVoxel> slicePropertyHandle_MultiClassRegionMask;
        spSliceXY->addProperty(slicePropertyHandle_MultiClassRegionMask, "MultiClassRegionMask", data::Storage::MultiClassRegionData::Id, data::Storage::SliceXY::Id, data::CSlice::PROPERTY_CHANGED, new data::CValidSourceFunctor);
    }

	{
        ...
        data::CSlicePropertyHandle<data::COrthoSliceXZ, data::CMultiClassRegionData, data::CMultiClassRegionData::tVoxel> slicePropertyHandle_MultiClassRegionMask;
        spSliceXZ->addProperty(slicePropertyHandle_MultiClassRegionMask, "MultiClassRegionMask", data::Storage::MultiClassRegionData::Id, data::Storage::SliceXZ::Id, data::CSlice::PROPERTY_CHANGED, new data::CValidSourceFunctor);
    }

	{
        ...
        data::CSlicePropertyHandle<data::COrthoSliceYZ, data::CMultiClassRegionData, data::CMultiClassRegionData::tVoxel> slicePropertyHandle_MultiClassRegionMask;
        spSliceYZ->addProperty(slicePropertyHandle_MultiClassRegionMask, "MultiClassRegionMask", data::Storage::MultiClassRegionData::Id, data::Storage::SliceYZ::Id, data::CSlice::PROPERTY_CHANGED, new data::CValidSourceFunctor);
    }

    {
        data::CObjectPtr<data::CArbitrarySlice> spSliceARB(APP_STORAGE.getEntry(data::Storage::ArbitrarySlice::Id));
        //data::CSlicePropertyHandle<data::CArbitrarySlice, data::CRegionData, data::CRegionData::tVoxel> slicePropertyHandle_RegionMask;
        //spSliceARB->addProperty(slicePropertyHandle_RegionMask, "RegionMask", data::Storage::RegionData::Id, data::Storage::ArbitrarySlice::Id, data::CSlice::PROPERTY_CHANGED, new data::CValidSourceFunctor);
        //data::CSlicePropertyHandle<data::CArbitrarySlice, data::CMultiClassRegionData, data::CMultiClassRegionData::tVoxel> slicePropertyHandle_MultiClassRegionMask;
        //spSliceARB->addProperty(slicePropertyHandle_MultiClassRegionMask, "MultiClassRegionMask", data::Storage::MultiClassRegionData::Id, data::Storage::ArbitrarySlice::Id, data::CSlice::PROPERTY_CHANGED, new data::CValidSourceFunctor);
    }
}
...
CExamination::~CExamination()
{
    ...
    data::CObjectPtr<data::CArbitrarySlice> spSliceARB(APP_STORAGE.getEntry(data::Storage::ArbitrarySlice::Id));
    spSliceARB->disconnectProperties();
}
...
void CExamination::init()
{
    ...
    SliceDeps.insert(MultiClassRegionData::Id).insert(MultiClassRegionColoring::Id);
    ...
    STORABLE_FACTORY.registerObject(ArbitrarySlice::Id, ArbitrarySlice::Type::create, SliceDeps);
    ...
    STORABLE_FACTORY.registerObject(MultiClassRegionData::Id, MultiClassRegionData::Type::create, CEntryDeps().insert(PatientData::Id));
    STORABLE_FACTORY.registerObject(MultiClassRegionColoring::Id, MultiClassRegionColoring::Type::create);
    ...
    STORABLE_FACTORY.registerObject(ModelPivot::Id, ModelPivot::Type::create, CEntryDeps());
    ...
    APP_STORAGE.getEntry(ArbitrarySlice::Id);
    ...
    APP_STORAGE.getEntry(MultiClassRegionData::Id);
    APP_STORAGE.getEntry(MultiClassRegionColoring::Id);
    ...
    APP_STORAGE.getEntry(ModelPivot::Id);
...
void CExamination::enableMultiClassRegionColoring(bool bEnable)
{
    CObjectPtr<CMultiClassRegionData> spRegionData(APP_STORAGE.getEntry(Storage::MultiClassRegionData::Id, Storage::NO_UPDATE));
...
bool CExamination::isMultiClassRegionColoringEnabled()
{
    CObjectPtr<CMultiClassRegionData> spRegionData(APP_STORAGE.getEntry(Storage::MultiClassRegionData::Id, Storage::NO_UPDATE));
...
void CExamination::setMultiClassRegionColor(int i, const CColor4b& Color)
{
    CObjectPtr<CMultiClassRegionColoring> spColoring(APP_STORAGE.getEntry(Storage::MultiClassRegionColoring::Id, Storage::NO_UPDATE));
...
CColor4b CExamination::getMultiClassRegionColor(int i)
{
...
void CExamination::setSlicePositionARB(int Position)
{
    CObjectPtr<CArbitrarySlice> spSlice(APP_STORAGE.getEntry(Storage::ArbitrarySlice::Id, Storage::NO_UPDATE));
...
double CExamination::getSliceDoublePositionARB()
{
    CObjectPtr<CArbitrarySlice> spSlice(APP_STORAGE.getEntry(Storage::ArbitrarySlice::Id));

    int posMin = spSlice->getPositionMin();
    int posMax = spSlice->getPositionMax();
    int pos = spSlice->getPosition();

    double doublePos = (pos * 1.0) / (posMax - posMin);
...
bool CExamination::subsample(data::CDensityData &densityData, ESubsamplingType subsamplingType, vpl::img::CVector3d& subsampling)
{
    ...
    VPL_LOG_INFO("Subsampling to " << subsampledSize.x() << "x" << subsampledSize.y() << "x" << subsampledSize.z())
