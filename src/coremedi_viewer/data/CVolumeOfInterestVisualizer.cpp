...
///////////////////////////////////////////////////////////////////////////////
//
CVolumeOfInterestVisualizer::CVolumeOfInterestVisualizer(osg::Matrix matrix, OSGCanvas *canvas, bool autoPositioning)
{
	m_matrix = matrix;
	m_canvas = canvas;
...
//
CVolumeOfInterestVisualizer::~CVolumeOfInterestVisualizer()
{ }

//
void CVolumeOfInterestVisualizer::setVisibility(bool show, bool forceRedraw)
{
    m_visible = show;
...
//
void CVolumeOfInterestVisualizer::updateData()
{ }

//
bool CVolumeOfInterestVisualizer::isVisible()
{
    return m_visible;
}

void CVolumeOfInterestVisualizer::setColor(const osg::Vec4 & color)
{
