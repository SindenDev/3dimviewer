...
//====================================================================================================================
//====================================================================================================================
scene::CSceneXY::CSceneXY( OSGCanvas * canvas ) : CSceneOSG( canvas, true, false, false )
{
...
//====================================================================================================================
scene::CSceneXZ::CSceneXZ( OSGCanvas * canvas ) : CSceneOSG( canvas, false, true, false )
{
	// rotate scene to face orthowindow
...
//====================================================================================================================
scene::CSceneYZ::CSceneYZ( OSGCanvas * canvas ) : CSceneOSG( canvas, false, false, true )
{
	// rotate scene to face orthowindow
...
//====================================================================================================================
scene::CSceneOSGVR::CSceneOSGVR(OSGCanvas *pCanvas, bool xyOrtho, bool xzOrtho, bool yzOrtho)
    : scene::CSceneOSG(pCanvas, xyOrtho, xzOrtho, yzOrtho)
{
...
//====================================================================================================================
scene::CSceneOSGVR::~CSceneOSGVR()
{ }

//====================================================================================================================
void scene::CSceneOSGVR::setRenderer(PSVR::PSVolumeRendering *pRenderer)
{
...
//====================================================================================================================
void scene::CSceneOSGVR::updateFromStorage()
{
    /*
    // Get the active dataset
    data::CObjectPtr<data::CDensityData> spData( APP_STORAGE.getEntry(VPL_SIGNAL(SigGetActiveDataSet).invoke2()) );
...
//====================================================================================================================
void scene::CSceneOSGVR::enableRenderer(bool enable)
{
    PSVR::osgPSVolumeRendering *pDrawable = dynamic_cast<PSVR::osgPSVolumeRendering *>(m_vrDrawable.get());
...
//====================================================================================================================
osg::Geode *scene::CSceneOSGVR::getVRGeode()
{
    return m_vrGeode.get();
}

//====================================================================================================================
scene::CScene3D::CScene3D( OSGCanvas * canvas ) : CSceneOSGVR( canvas, false, false, false )
{
	m_orthoTransformMatrix = osg::Matrix::identity();

    m_conWorld[0] = VPL_SIGNAL( SigGetYZWorld ).connect( this, &CScene3D::getYZWorld );
    m_conWorld[1] = VPL_SIGNAL( SigGetXZWorld ).connect( this, &CScene3D::getXZWorld );
    m_conWorld[2] = VPL_SIGNAL( SigGetXYWorld ).connect( this, &CScene3D::getXYWorld );

    osg::Matrix m = osg::Matrix::identity();    
    createWidgetsScene( canvas, m, SW_INFO | SW_ORIENT | CSceneOrientationWidget::SW_ALL_LABELS | CSceneOrientationWidget::SW_MOVABLE );
}
...
//====================================================================================================================
osg::Vec3 scene::CScene3D::getXYWorld()
{
    return this->getSliceXY()->getWorldPosition();
}

//====================================================================================================================
osg::Vec3 scene::CScene3D::getXZWorld()
{
    return this->getSliceXZ()->getWorldPosition();
}

//====================================================================================================================
osg::Vec3 scene::CScene3D::getYZWorld()
{
