...
///////////////////////////////////////////////////////////////////////////////
//
CMultiClassRegionsVisualizer::CMultiClassRegionsVisualizer(osg::Matrix matrix, OSGCanvas *canvas, bool autoPositioning)
{
	m_matrix = matrix;
	m_canvas = canvas;
...
//
CMultiClassRegionsVisualizer::~CMultiClassRegionsVisualizer()
{ }

//
void CMultiClassRegionsVisualizer::setVisibility(bool show, bool forceRedraw)
{
    m_visible = show;
...
//
void CMultiClassRegionsVisualizer::updateData()
{ }

//
bool CMultiClassRegionsVisualizer::isVisible()
{
    return m_visible;
}

void CMultiClassRegionsVisualizer::setColor(const osg::Vec4 & color)
{
