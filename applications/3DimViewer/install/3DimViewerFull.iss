...
LicenseFile=..\install\license_full.txt
OutputDir=..\install
OutputBaseFilename=3DimViewer_Full_v2.1-setup
Compression=lzma
...
Root: HKLM; Subkey: "Software\3Dim Laboratory s.r.o.\3DimViewer Segmentation Plugins\Settings"; ValueType: string; ValueName: "Version"; ValueData: "2.1"
