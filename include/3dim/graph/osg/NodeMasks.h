...
#define SCANBODY_DRAGGER_EH_MASK 1 << 7
#define OVERLAY_ITEM_EH_MASK 1 << 8
#define MASK_NERVE_DRAGGER 1 << 9
#define MASK_CURVE_DRAGGER 1 << 10
#define MASK_MODEL_DRAGGER 1 << 11
